...
由于维护多个文档太累，Github flavor markdown不支持视频，并且gif图大点就不显示，还得空两格才会换行，基于种种原因，如果要继续查看文档，请直接查看唯一文档：[PicUploader: 一个还不错的图床工具](https://www.xiebruce.top/17.html)（由于博客搭建在海外服务器，受最近大规模封禁海外vps ip影响，图片目前无法加载，正在解决中……）。
