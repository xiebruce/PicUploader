...
* @link      https://graph.microsoft.com
*/
class SearchSettings extends \Microsoft\Graph\Model\Entity
{
    ...
    */
    public function getSearchResultTemplates()
    {
        if (array_key_exists("searchResultTemplates", $this->_propDict)) {
            if (is_a($this->_propDict["searchResultTemplates"], "\Microsoft\Graph\ExternalConnectors\Model\DisplayTemplate") || is_null($this->_propDict["searchResultTemplates"])) {
