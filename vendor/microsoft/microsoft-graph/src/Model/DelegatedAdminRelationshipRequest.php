    ...
    */
    public function getAction()
    {
        if (array_key_exists("action", $this->_propDict)) {
            if (is_a($this->_propDict["action"], "\Microsoft\Graph\Model\DelegatedAdminRelationshipRequestAction") || is_null($this->_propDict["action"])) {
    ...
    */
    public function getStatus()
    {
        if (array_key_exists("status", $this->_propDict)) {
            if (is_a($this->_propDict["status"], "\Microsoft\Graph\Model\DelegatedAdminRelationshipRequestStatus") || is_null($this->_propDict["status"])) {
