    ...
    */
    public function getConfiguration()
    {
        if (array_key_exists("configuration", $this->_propDict)) {
            if (is_a($this->_propDict["configuration"], "\Microsoft\Graph\Model\OnPremisesDirectorySynchronizationConfiguration") || is_null($this->_propDict["configuration"])) {
    ...
    */
    public function getFeatures()
    {
        if (array_key_exists("features", $this->_propDict)) {
            if (is_a($this->_propDict["features"], "\Microsoft\Graph\Model\OnPremisesDirectorySynchronizationFeature") || is_null($this->_propDict["features"])) {
