...
* @link      https://graph.microsoft.com
*/
class EventPropagationResult extends \Microsoft\Graph\Model\Entity
{
    /**
    * Gets the location
    ...
    */
    public function getStatus()
    {
        if (array_key_exists("status", $this->_propDict)) {
            if (is_a($this->_propDict["status"], "\Microsoft\Graph\SecurityNamespace\Model\EventPropagationStatus") || is_null($this->_propDict["status"])) {
